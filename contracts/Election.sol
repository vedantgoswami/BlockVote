...
contract Election{
   ...
   // fetch candidate 
    ...
    function addCandidate (string memory _name,uint _age,string memory _party,string memory _qualification) public returns(string memory status) {
      require(electionState==1);
      candidatesCount++;
      candidates[candidatesCount] = Candidate(candidatesCount,_name,_age,_party,_qualification,0,"No Image");
      return "sucess";
    }
